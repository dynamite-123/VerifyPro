#!/usr/bin/env node
// Fix indexes: unset null/empty indexed fields and recreate sparse unique indexes
import mongoose from 'mongoose';
import dotenv from 'dotenv';
import path from 'path';

// Load server .env from project root server folder reliably
...
async function run() {
  ...
  // Drop any index that targets aadhaarCard.number or panCard.pan_number
